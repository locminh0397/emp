...
import { AiOutlineCalendar, AiOutlineShoppingCart, AiOutlineAreaChart, AiOutlineBarChart, AiOutlineStock, AiOutlineFileProtect } from 'react-icons/ai';
import { FiShoppingBag, FiEdit, FiPieChart, FiBarChart, FiCreditCard, FiStar, FiShoppingCart } from 'react-icons/fi';
import { BsKanban, BsBarChart, BsBoxSeam, BsCurrencyDollar, BsShield, BsChatLeft, BsBuilding, BsGift } from 'react-icons/bs';
import { BiColorFill, BiUser, BiTimeFive } from 'react-icons/bi';
import { AiOutlineHome, AiOutlineUser, AiOutlineFieldTime, AiOutlineMessage, AiOutlineAudit, AiOutlineSafety } from 'react-icons/ai';
import { RiNotification3Line } from 'react-icons/ri';

import { IoMdContacts,IoMdNotifications } from 'react-icons/io';
import { RiContactsLine, RiStockLine } from 'react-icons/ri';
import { MdOutlineSupervisorAccount, MdHomeRepairService, MdError } from 'react-icons/md';
...
export const links_admin = [
...

  {
    ...
    links: [
      ...
      {
        name: 'Hợp đồng nhân viên',
        to: '/admin/contract',
        icon: <FaFileSignature />
      },
      {
        name: 'Bằng cấp nhân viên',
        to: '/admin/degree',
        icon: <TbCertificate />
      },
      {
