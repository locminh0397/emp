...
const DegreeCreate = () => {
  ...
  const handleSubmit = async (values) => {
    await fetch(`/api/admin/bangcap/${id}/create`, {
      method: "POST",
      headers: {
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 md:gap-6">
                        ...
                        <SelectInput
                          ...
                          options={[
                            {
                              value: "Chứng chỉ anh văn",
                              label: "Chứng chỉ anh văn",
                            },
                            {
                              value: "Chứng chỉ tin học",
                              label: "Chứng chỉ tin học",
                            },
                            { value: "Bằng đại học", label: "Bằng đại học" },
                            { value: "Bằng cao đẳng", label: "Bằng cao đẳng" },
                            {
                              value: "Bằng trung cấp nghề",
                              label: "Bằng trung cấp nghề",
                            },
                          ]}
                          className="shadow appearance-none border border-slate-950 rounded-lg w-full p-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-blue-500"
                        />
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 md:gap-6">
                        ...
                        <SelectInput
                          ...
                          options={[
                            ...
                            {
                              value: "Vừa làm vừa học",
                              label: "Vừa làm vừa học",
                            },
                            {
                              value: "Đào tạo ngắn hạn",
                              label: "Đào tạo ngắn hạn",
                            },
                            {
                              value: "Đào tạo dài hạn",
                              label: "Đào tạo dài hạn",
                            },
                            {
                              value: "Đào tạo chuyên sâu",
                              label: "Đào tạo chuyên sâu",
                            },
                            {
                              value: "Đào tạo cơ bản",
                              label: "Đào tạo cơ bản",
                            },
                            {
                              value: "Đào tạo nghề nghiệp",
                              label: "Đào tạo nghề nghiệp",
                            },
                            {
                              value: "Đào tạo văn bằng",
                              label: "Đào tạo văn bằng",
                            },
                            {
                              value: "Đào tạo chính quy",
