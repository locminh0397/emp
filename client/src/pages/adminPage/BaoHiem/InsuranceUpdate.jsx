...
const InsuranceUpdate = () => {
    ...
    const [getDataBaoHiem, setGetDataBaoHiem] = useState(null);
    const { id } = useParams();
    const getBaoHiem = async () => {
        await fetch(`/api/admin/baohiem/${id}`, {
            method: 'GET',
            headers: {
    ...
    // }
    let dataEmployee=[{
        value: getDataBaoHiem.getBaoHiem.NhanVien.id,
        label: getDataBaoHiem.getBaoHiem.NhanVien.HoTen
    }]
    const initialValuesInsurance = {
        idNhanVien: getDataBaoHiem.getBaoHiem.NhanVien.id,
        insuranceCode: getDataBaoHiem.getBaoHiem.MaBH,
        dateStart: getDataBaoHiem.getBaoHiem.NgayBD,
        insurancePremium: getDataBaoHiem.getBaoHiem.MucDong,
        percentCompany: getDataBaoHiem.getBaoHiem.PhanTramCT,
        percentEmployee: getDataBaoHiem.getBaoHiem.PhanTramLD,
        moneyEmployee: getDataBaoHiem.getBaoHiem.NhanVienDong,
        creator: getDataBaoHiem.getBaoHiem.NguoiThucHien,
        noteInsurance: getDataBaoHiem.getBaoHiem.GhiChu
    }
        ...
        <div className='mt-20 md:mt-8 mx-auto w-full md:w-[90%]'>
            <div className='flex flex-wrap lg:flex-nowrap justify-between '>
                <div className='p-4 text-xl md:text-3xl font-bold'>
                    <h1>Cập nhật bảng ghi bảo hiểm</h1>
                </div>
            </div>
