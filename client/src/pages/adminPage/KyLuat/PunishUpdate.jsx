...
const PunishUpdate = () => {
  ...
  let dataEmployeePunish = [];
  for (let i = 0; i < getDataPunish.getKyLuat.nhanvien.length; i++) {
    dataEmployeePunish.push({
      value: getDataPunish.getKyLuat.nhanvien[i].id,
      label: getDataPunish.getKyLuat.nhanvien[i].HoTen,
    });
  }
  let dataEmployee = [];
  ...
  const initialValuePunish = {
    punishCode: getDataPunish.getKyLuat.MaKL,
    decisionNumber: getDataPunish.getKyLuat.SoQD,
    dateDecision: getDataPunish.getKyLuat.NgayQD,
    title: getDataPunish.getKyLuat.TieuDe,
    mouth: getDataPunish.getKyLuat.Thang,
    moneyPunish: getDataPunish.getKyLuat.TienPhat,
    contentPunish: getDataPunish.getKyLuat.NoiDung,
    idNhanVien: dataEmployeePunish,
  };
