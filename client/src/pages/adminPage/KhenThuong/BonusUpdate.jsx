...
const BonusUpdate = () => {
    ...
    const getBonus = async () => {
        await fetch(`/api/admin/khenthuong/${id}`, {
            method: 'GET',
            headers: {
    ...
    let dataEmployeeBonus=[];
    for (let i=0;i<getDataBonus.getKhenThuong.nhanvien.length;i++){
        dataEmployeeBonus.push({
            value: getDataBonus.getKhenThuong.nhanvien[i].id,
            label: getDataBonus.getKhenThuong.nhanvien[i].HoTen
        })
    }
    let dataEmployee = []
    ...
    const initialValueBonus = {
        bonusCode: getDataBonus.getKhenThuong.MaKT,
        decisionNumber: getDataBonus.getKhenThuong.SoQD,
        dateDecision: getDataBonus.getKhenThuong.NgayQD,
        title: getDataBonus.getKhenThuong.TieuDe,
        mouth: getDataBonus.getKhenThuong.Thang,
        moneyBonus: getDataBonus.getKhenThuong.TienThuong,
        contentBonus: getDataBonus.getKhenThuong.NoiDung,
        idNhanVien: dataEmployeeBonus,
    }
    const handleSubmit = async (values) => {
        await fetch(`/api/admin/khenthuong/${id}/update`, {
            method: 'PUT',
            headers: {
